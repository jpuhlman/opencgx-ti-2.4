...
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-montavista-cgl.git;branch=rocko \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-ti.git;branch=rocko \
MACHINE@k2hk-evm \
DISTRO@mvista-cgx \
"
